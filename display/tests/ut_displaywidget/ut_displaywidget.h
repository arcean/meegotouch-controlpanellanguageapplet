...
private slots:
    ...
    void testShowFullScreenMessage();
    void testTitle();
    void testSelectedItem();
    void testOnLanguageSelected();
    void testOnChangeLanguageDialogRejected();
    void testStartSpinner();
    void testChangeLanguageAndClose();
    void testSelectCurrentLanguage();
    void testPolishEvent();
    void testScrollToSelected();
    void testChangeOrientation();
    void testLiveFilteringTextChangedSlot();
    void testFilteringVkbSlot();
    void testShowTextEdit();
    void testDisplayLangCellCreator();
