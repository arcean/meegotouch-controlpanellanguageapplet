...
static DcpDisplayLangConf::ScriptClass g_scriptClass;
...
void setDcpDisplayLangConfStubScriptClass(DcpDisplayLangConf::ScriptClass script) {
    g_scriptClass = script;
}
